...
#                              pastries GET      /pastries(.:format)                          products#pastries_index
#                            delicacies GET      /delicacies(.:format)                        products#delicacies_index
...
Rails.application.routes.draw do
  ...
  get 'pastries', to: 'products#pastries_index'
  get 'delicacies', to: 'products#delicacies_index'
